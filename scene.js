...
let allProducts = [
  {
    ...
    icon: "https://i.pinimg.com/736x/19/28/7c/19287c8799f8c0ce38103cfe7a240bea.jpg",
    price: 8990000,
    ori: 12990000,
    disc: 30,
    status: "active",
  ...
  {
    id: 2,
    name: "Tai nghe Baseus Wm2",
    icon: "https://i.pinimg.com/736x/32/53/ee/3253eee1d4d2f9079076d005fce8631a.jpg",
    price: 5490000,
    ori: 9990000,
    disc: 45,
    status: "active",
  ...
  {
    id: 3,
    name: "Laptop ThinkPad X1 Carbon Gen 15",
    icon: "https://i.pinimg.com/736x/10/41/61/1041617893c350c59c14bca6639f102e.jpg",
    price: 12490000,
    ori: 16590000,
    disc: 25,
    status: "active",
  ...
  },
  {
    ...
    icon: "https://i.pinimg.com/736x/32/e1/60/32e16036e4c88b0079199a697b464bdc.jpg",
    price: 9290000,
    ori: 11590000,
    disc: 20,
    status: "active",
  ...
  {
    id: 5,
    name: "Máy ảnh Canon V12",
    icon: "https://i.pinimg.com/736x/0c/30/ab/0c30ab1f0e78f71a0e66be03fcc79c57.jpg",
    price: 14990000,
    ori: 22990000,
    disc: 35,
    status: "active",
  ...
  },
  {
    id: 6,
    name: "Giày Nike AF1",
    icon: "https://i.pinimg.com/736x/63/e9/da/63e9da7962190e04440a5c8ba2e65aa0.jpg",
    price: 2450000,
    ori: 3200000,
    disc: 23,
    status: "active",
  ...
  },
  {
    id: 7,
    name: "Hộp Gói quà",
    icon: "https://i.pinimg.com/736x/88/68/c1/8868c1254d97a25cc596f634f7f7ebaf.jpg",
    price: 389000,
    ori: 650000,
    disc: 40,
    status: "active",
  ...
  {
    id: 8,
    name: "Nồi Chiên Không Dầu AceCook",
    icon: "https://i.pinimg.com/736x/06/dd/b6/06ddb6e51ef064bfb5842a099e2d84aa.jpg",
    price: 1290000,
    ori: 2190000,
    disc: 41,
    status: "active",
  ...
  {
    id: 9,
    name: "Vitamin C Pharmacy",
    icon: "https://i.pinimg.com/736x/d9/de/e1/d9dee1dff4bc97cc67b4f0d483173980.jpg",
    price: 285000,
    ori: 420000,
    disc: 32,
    status: "active",
  ...
  {
    id: 10,
    name: "Bàn Chải Điện Colgate",
    icon: "https://i.pinimg.com/736x/a5/d6/d5/a5d6d548a5f03ca7a28f7dec3db977b0.jpg",
    price: 590000,
    ori: 890000,
    disc: 34,
    status: "active",
  ...
  {
    id: 11,
    name: "Máy Tăm Nước Panasonic",
    icon: "https://i.pinimg.com/736x/7f/11/b5/7f11b58760bc2f928e1c494bdcbebb9c.jpg",
    price: 1250000,
    ori: 1800000,
    disc: 31,
    status: "active",
  ...
  },
  {
    ...
    icon: "https://i.pinimg.com/736x/e3/d2/26/e3d226a2bd6dc59cec014349cdddbc2e.jpg",
    price: 850000,
    ori: 1200000,
    disc: 29,
    status: "active",
  ...
  {
    id: 13,
    name: "Vợt Cầu Lông Yonex 1000zz",
    icon: "https://i.pinimg.com/736x/30/69/a6/3069a67a901069a6b849bfff9f656178.jpg",
    price: 9900000,
    ori: 11500000,
    disc: 14,
    status: "active",
  ...
  {
    id: 14,
    name: "Cặp sách Degrey",
    icon: "https://i.pinimg.com/736x/8b/98/5a/8b985a52779e7e0565b6eb24e1b96f76.jpg",
    price: 650000,
    ori: 950000,
    disc: 32,
    status: "active",
  ...
  },
  {
    id: 15,
    name: "Lego Ninjago",
    icon: "https://i.pinimg.com/736x/42/df/1b/42df1bab743a5e8e0e530feb7d920288.jpg",
    price: 3200000,
    ori: 4500000,
    disc: 29,
    status: "active",
  ...
  {
    id: 16,
    name: "Áo Choàng Tàng Hình Của Doraemon",
    icon: "https://i.pinimg.com/736x/21/0c/cc/210cccb91cd4e5f770b66177f5492dba.jpg",
    price: 1100000,
    ori: 1550000,
    disc: 29,
    status: "active",
  ...
  {
    id: 17,
    name: "Đồng Hồ Ngưng Đọng Thời Gian",
    icon: "https://i.pinimg.com/736x/92/44/87/9244875ae0a2fc831f90ce3e8e112e36.jpg",
    price: 450000,
    ori: 720000,
    disc: 38,
    status: "active",
  ...
  {
    id: 18,
    name: "Đồng hồ Ben 10 Alien Ultimate",
    icon: "https://i.pinimg.com/736x/8e/fd/14/8efd146b3c054c830daccbb2f3cc7c9d.jpg",
    price: 2800000,
    ori: 3600000,
    disc: 22,
    status: "active",
  ...
  {
    id: 19,
    name: "Sách Hoàng Tử Bé",
    icon: "https://i.pinimg.com/736x/17/51/ae/1751ae921f523867b85b1e732dcd949e.jpg",
    price: 3500000,
    ori: 4200000,
    disc: 17,
    status: "active",
  ...
  },
  {
    ...
    icon: "https://i.pinimg.com/736x/f5/2a/03/f52a03fffef89546778908c26d8e96cf.jpg",
    price: 1950000,
    ori: 2500000,
    disc: 22,
    status: "active",
  ...
  {
    id: 21,
    name: "Tivi Coocaa 50 inches",
    icon: "https://i.pinimg.com/736x/54/5d/e2/545de284367bf4513b6ce456f0341db1.jpg",
    price: 1650000,
    ori: 2100000,
    disc: 21,
    status: "active",
  ...
  {
    id: 22,
    name: "Áo Giữ Nhiệt Faraha",
    icon: "https://i.pinimg.com/736x/90/72/f8/9072f8dbae0edc6335d8afcb031c9755.jpg",
    price: 6800000,
    ori: 8500000,
    disc: 20,
    status: "active",
  ...
  },
  {
    ...
    icon: "https://i.pinimg.com/736x/5c/2a/91/5c2a91eb9dd6cf8bcbf800bba4a9ef1a.jpg",
    price: 5400000,
    ori: 7000000,
    disc: 23,
    status: "active",
  ...
  },
  {
    id: 24,
    name: "PS5",
    icon: "https://i.pinimg.com/736x/30/35/7f/30357f6208f2ce95bfebf0259083b29d.jpg",
    price: 4200000,
    ori: 5800000,
    disc: 28,
    status: "active",
  ...
  {
    id: 25,
    name: "G-IDLE Tomboy Album",
    icon: "https://i.pinimg.com/736x/85/5f/73/855f737aafe4a9fcf9dfe9ab766e5a0f.jpg",
    price: 8900000,
    ori: 12000000,
    disc: 26,
    status: "active",
  ...
  },
  {
    id: 26,
    name: "Sen Đá",
    icon: "https://i.pinimg.com/736x/e1/e3/81/e1e381302c2bb2dbf80f3e148572dd12.jpg",
    price: 1350000,
    ori: 1900000,
    disc: 29,
    status: "active",
  ...
  {
    id: 27,
    name: "Kiếm Kim Cương Minecraft",
    icon: "https://i.pinimg.com/736x/43/7c/11/437c11f6cd55d6366a9c06f1f42d13c3.jpg",
    price: 550000,
    ori: 800000,
    disc: 31,
    status: "active",
  ...
  {
    id: 28,
    name: "Găng tay Adidas Predator",
    icon: "https://i.pinimg.com/736x/02/85/01/02850105ae45b3438cbdedadc729c975.jpg",
    price: 390000,
    ori: 600000,
    disc: 35,
    status: "active",
  ...
  {
    id: 29,
    name: "Sạc Dự Phòng Samsung 20000mAh",
    icon: "https://i.pinimg.com/736x/a8/69/06/a869063887ccf1d4a7bf298b10a1040c.jpg",
    price: 850000,
    ori: 1100000,
    disc: 23,
    status: "active",
  ...
  {
    id: 30,
    name: "SkateBoard Yoric Verse2",
    icon: "https://i.pinimg.com/736x/42/77/10/427710ab16bc59b81d02b7cbd44c95fe.jpg",
    price: 450000,
    ori: 650000,
    disc: 31,
    status: "active",
...
const calcDisc = (price, ori) =>
  ori > price ? Math.round((1 - price / ori) * 100) : 0;
...
function doSellerRegister() {
  ...
  if (pass !== pass2) {
    document.getElementById("sellerRegErr").textContent =
...
function initProducts() {
  ...
  document.getElementById("objectProducts").innerHTML = actived
    .map((p) => makeProductCard(p))
    .join("");
}
...
function renderCart() {
  ...
  if (lbl)
    lbl.textContent =
      cart.length > 0
        ? `(${cart.reduce((s, c) => s + c.qty, 0)} sản phẩm)`
        : "";
  if (cart.length === 0) {
...
function doCheckout() {
  if (!cart.filter((c) => c.checked).length) {
    showToast("error", "⚠ Chọn sản phẩm để đặt hàng");
    return;
  }
  if (!currentUser) {
...
function getMyProducts() {
  return allProducts.filter((p) => p.sellerOwned);
}
...
function renderProductTable(prods) {
  if (prods.length === 0)
    return `<div class="empty-table"><div class="ei"></div><p>Chưa có sản phẩm nào. Hãy thêm sản phẩm đầu tiên!</p><button class="btn-add-product" style="margin:10px auto" onclick="openProductForm(null)">➕ Thêm Sản Phẩm</button></div>`;
  return `<table class="prod-table">
    ...
    <tbody>${prods
      .map(
        (p) => `<tr id="prod-row-${p.id}">
      <td><div class="prod-name-cell"><div class="prod-thumb"><img src = ${p.icon} style = "max-width:100%;max-height:100%"></div><div><div class="pn-name">${p.name}</div></div></div></td>
      <td><div class="tbl-price">${fmt(p.price)}</div></td>
      <td><div style="color:#aaa;font-size:12px">${p.ori >= p.price ? fmt(p.ori) : fmt(p.price)}</div></td>
...
function toggleProductStatus(pid) {
  ...
  showToast(
    "success",
    `${p.status === "active" ? "Đã mở bán" : "Đang tạm ngừng bán"}: ${p.name}`,
  );
...
function saveProduct() {
  ...
  if (price < 0 || ori < 0) {
    showToast("error", "Giá sản phẩm phải >= 0đ");
    return;
  }
  if (editingProductId) {
...
function confirmDelete(pid) {
  ...
  document.getElementById("deleteConfirmMsg").textContent =
    `Xóa "${p?.name}"? Hành động này không thể quay lại.`;
...
document.querySelectorAll(".lz-flash-tab button").forEach((b) =>
  b.addEventListener("click", function () {
    document
      .querySelectorAll(".lz-flash-tab button")
